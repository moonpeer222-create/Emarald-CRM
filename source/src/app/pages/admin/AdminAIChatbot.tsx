...
import { Bot, MessageCircle, Sparkles, Zap, Brain, Shield } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: isUrdu ? "کیسز تلاش، اپڈیٹ، ادائیگی ریکارڈ، نیا کیس — AI سے" : "Search, update, record payments, create cases — via AI",
      descUrdu: "کیسز تلاش، اپڈیٹ، ادائیگی ریکارڈ، نیا کیس — AI سے"
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: isUrdu ? "ذہین تجزیہ" : "Smart Analytics",
      titleUrdu: "ذہین تجزیہ",
      desc: isUrdu ? "ایجنٹ کارکردگی، تاخیر کی پیش گوئی، آمدنی رپورٹ" : "Agent performance, delay prediction, revenue report",
      descUrdu: "ایجنٹ کارکردگی، تاخیر کی پیش گوئی، آمدنی رپورٹ"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: isUrdu ? "فوری منظوریاں" : "Quick Approvals",
      titleUrdu: "فوری منظوریاں",
      desc: isUrdu ? "زیر التواء منظوریاں اور فوری کارروائیاں" : "Pending approvals and urgent actions",
      descUrdu: "زیر التواء منظوریاں اور فوری کارروائیاں"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: isUrdu ? "ایسکیلیشن اور حفاظت" : "Escalation & Safety",
      titleUrdu: "ایسکیلیشن اور حفاظت",
      desc: isUrdu ? "ڈیٹا پرائیویسی، آڈٹ ٹریل، خودکار ایسکیلیشن" : "Data privacy, audit trail, auto-escalation",
      descUrdu: "ڈیٹا پرائیویسی، آڈٹ ٹریل، خودکار ایسکیلیشن"
    },
  ];

  const sampleQuestions = [
    { q: "Show all cases", qUrdu: "تمام کیسز دکھاؤ" },
    { q: "Agent performance", qUrdu: "ایجنٹ کارکردگی کا تجزیہ" },
    { q: "Overdue cases", qUrdu: "تاخیر والے کیسز" },
    { q: "Financial summary", qUrdu: "مالیاتی خلاصہ" },
    { q: "Create new case", qUrdu: "نیا کیس بناؤ" },
    { q: "Flag a case", qUrdu: "کیس فلگ کرو" },
  ];
    ...
    <div className={`${isUrdu ? fontClass : ""} ${insideUnifiedLayout ? "" : "flex min-h-screen"} transition-colors duration-300 ${darkMode ? "bg-gray-950" : "bg-gradient-to-br from-gray-50 to-gray-100"}`}>
      ...
      <div className={`flex-1 min-w-0 ${insideUnifiedLayout ? "" : "pt-14 lg:pt-0"}`}>
        ...
        <main className="p-3 sm:p-4 md:p-6 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
                  {isUrdu ? "ایڈمن کے لیے ذہین اردو/انگریزی اسسٹنٹ" : "Intelligent Urdu/English Assistant for Admins"}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h3 className={`font-bold mb-3 ${darkMode ? "text-blue-400" : "text-blue-900"}`}>
              {isUrdu ? "کیسے استعمال کریں:" : "How to Use:"}
            </h3>
            <ul className={`space-y-2 text-sm ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 font-bold">1.</span>
                <span>{isUrdu ? "نیچے دائیں جانب چیٹ بٹن پر کلک کریں" : "Click the chat button at the bottom left"}</span>
              </li>
              <li className="flex items-start gap-2">
